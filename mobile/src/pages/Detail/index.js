...
export default function Detail(){
    ...
    const message = `Olá ${incident.name}, Gostária de ajudar no seu caso (${incident.title}) com o valor de ${Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(incident.value)}.`;
